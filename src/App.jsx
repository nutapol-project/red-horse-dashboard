      ...
      <div className="p-4 max-w-6xl mx-auto space-y-4 pb-12">
        ...
        {tab === "audit" && (
          <>
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                { label:"INFO", count: AUDIT_LOGS.filter(l=>l.level==="INFO").length,
                  color:"text-blue-400",   bg:"bg-blue-950",   border:"border-blue-800" },
                { label:"WARN", count: AUDIT_LOGS.filter(l=>l.level==="WARN").length,
                  color:"text-yellow-400", bg:"bg-yellow-950", border:"border-yellow-800" },
                { label:"CRIT", count: AUDIT_LOGS.filter(l=>l.level==="CRIT").length,
                  color:"text-red-400",    bg:"bg-red-950",    border:"border-red-800" },
